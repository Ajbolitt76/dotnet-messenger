...
namespace Messenger.Data.Migrations
{
    ...
    [Migration("20230506170956_AddUserStatusAndSubscriptions")]
    partial class AddUserStatusAndSubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Messenger.Core.Model.SubscriptionAggregate.UserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Messenger.Core.Model.ConversationAggregate.ConversationMessage", b =>
                {
                    b.HasOne("Messenger.Core.Model.UserAggregate.MessengerUser", "SenderMessengerUser")
                        .WithMany()
                        .HasForeignKey("SenderId");

                    b.Navigation("SenderMessengerUser");
                });
            ...
            modelBuilder.Entity("Messenger.Core.Model.SubscriptionAggregate.UserSubscription", b =>
                {
                    b.HasOne("Messenger.Core.Model.UserAggregate.MessengerUser", null)
                        .WithOne()
                        .HasForeignKey("Messenger.Core.Model.SubscriptionAggregate.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
